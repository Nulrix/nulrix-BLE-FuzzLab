...
```bash
python3 ble_fuzzlab.py --target AA:BB:CC:DD:EE:FF --profile smart_lock --active
```

Features
--------
- **Device Discovery:** Async scanning for BLE devices with RSSI and service data  
...
Supported Fuzzing Techniques
----------------------------
- **Passive Reconnaissance:** Device discovery and service enumeration without active interaction  
...
Ethics & Safety
---------------
- **Authorization Required:** This tool connects directly to BLE devices. Always ensure you have explicit permission before testing.  
...
Common Use Cases
----------------
- Smart Lock Security: Testing electronic lock mechanisms  
...
Files
-----
- `ble_fuzzlab.py`: The main CLI tool implementing device discovery, service enumeration, and comprehensive fuzzing  
...
Device Profiles
---------------
The tool includes specialized fuzzing profiles for:
...
python3 ble_fuzzlab.py --target AA:BB:CC:DD:EE:FF --monitor --duration 300
```

Extending
---------
- Add custom fuzzing payloads by modifying the `_generate_fuzz_payloads()` method  
